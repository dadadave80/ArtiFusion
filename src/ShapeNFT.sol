    ...
    AccessControlUpgradeable
{
    ...
    IERC6551Registry public constant IERC6551_REGISTRY = IERC6551Registry(ERC6551_REGISTRY);
    ...
    function initialize(address _defaultAdmin, string calldata _name, string calldata _uri)
        public
        initializer
        returns (address tbaAddress_)
    {
        ...
        _setTokenURI(1, _uri);
        tbaAddress_ = IERC6551_REGISTRY.createAccount(ACCOUNT_V3_IMPLEMENTATION, "", block.chainid, address(this), 1);
    }
        ...
        returns (uint256 tokenId_, address tbaAddress_)
    {
        ...
        tbaAddress_ =
            IERC6551_REGISTRY.createAccount(ACCOUNT_V3_IMPLEMENTATION, "", block.chainid, address(this), tokenId_);
    }
        ...
        returns (string memory)
    {
        ...
        return string(bytes.concat("https://ipfs.io/ipfs/", bytes(ERC721URIStorageUpgradeable.tokenURI(_tokenId))));
    }
